...
**Technologies:** Wazuh SIEM, Microsoft Sysmon, Windows 11, Kali Linux, MITRE ATT&CK, XML/PCRE2  
...
1. **Rule 100050:** Detects the specific `comsvcs.dll` structure called by `rundll32.exe` mapping to T1003.001.
2. **Rule 100051:** Utilizes PCRE2 regex `(?i)delete shadows` across the Windows event group to catch Ransomware-like volume shadow manipulation regardless of the binary name used, mapping to T1490.
